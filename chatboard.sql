...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2020 at 07:36 PM
...
CREATE TABLE `categories` (
  ...
  `cat_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(3, '2020_02_02_112804_create_messages_table', 1),
(4, '2020_04_03_011059_create_posts_table', 1),
(5, '2020_04_05_012009_create_comments_table', 1),
(6, '2020_04_05_012029_create_friends_table', 1),
(7, '2020_04_05_012043_create_likes_table', 1),
(8, '2020_04_05_012506_create_friend_post_table', 1),
(9, '2020_04_07_003556_create_categories_table', 1),
(10, '2020_04_07_003817_create_sub_categories_table', 1),
(11, '2020_04_07_012758_create_suppliers_table', 1),
(12, '2020_04_30_153819_create_repository_table', 1);
...
CREATE TABLE `repository` (
  ...
  `studnet_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sub_categories` (
  ...
  `under_cat` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `repository`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `repository_title_unique` (`title`);
