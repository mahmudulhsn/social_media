                  ...
                  <ul class="nav nav-tabs contact-list scrollbar-wrapper scrollbar-outer">
                    ...
                    <li>
                      <a href="#contact-2" data-toggle="tab">
                        <div class="contact">
                          <img src="{{asset('public/all/images/users/user-10.jpg')}}" alt="" class="profile-photo-sm pull-left"/>
                          <div class="msg-preview">
                            <h6>Julia Cox</h6>
                  ...
                  <div class="tab-content scrollbar-wrapper wrapper scrollbar-outer">
                    <div class="tab-pane active" id="contact-1">
                      <div class="chat-body">
                          ...
                          <li class="right">
                      			<img src="{{asset('public/all/images/users/user-8.jpg')}}" alt="" class="profile-photo-sm pull-right" />
                      			<div class="chat-item">
                              <div class="chat-item-header">
                              	<h5>Sarah Cruiz</h5>
                              	<small class="text-muted">3 days ago</small>
                    ...
                    <div class="tab-pane" id="contact-2">
                      <div class="chat-body">
                          ...
                          <li class="right">
                      			<img src="{{asset('public/all/images/users/user-1.jpg')}}" alt="" class="profile-photo-sm pull-right" />
                      			<div class="chat-item">
                              <div class="chat-item-header">
                              	<h5>Sarah Cruiz</h5>
                              	<small class="text-muted">a day ago</small>
